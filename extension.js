...
// === BOUTON UPDATE (GOINFRE INSTALL) ===
        ...
        updateBtn.connect('clicked', () => {
            try {
                ...
                let cmd = `bash -c "cd ~/.local/share/gnome-shell/extensions && rm -rf logtime@42 && git clone https://github.com/BalkamFR/logtime.git logtime@42 && cd logtime@42 && chmod +x install.sh && ./install.sh"`;
